    ...
    <div id="auth">
        <sc-form-wrap class="mt-5">
            ...
            <div class="form-group">
                ...
                <b-button size="lg" variant="primary" class="btn-block" @click.prevent="submitResetPassword" :disabled="resetPasswordForm.submiting">
                    <i :class="resetPasswordForm.submiting ? 'fas fa-spinner' : 'fas fa-check'"></i>&nbsp;&nbsp;
