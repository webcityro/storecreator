...
/* harmony import */ var _core_User__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../core/User */ "./resources/js/core/User.js");
...
new Vue({
  ...
  data: {
    ...
    form: new Form({
      ...
      email: '',
      password: '',
      passwordType: undefined.userRow ? 'dontChange' : 'set',
      status: '',
      roles: [],
      stores: []
    }),
    passwordOptions: [{
      text: trans('formLabels.passwordSet'),
      value: 'set'
    }, {
      text: trans('formLabels.passwordAuto'),
      value: 'auto'
    }]
  },
  mounted: function mounted() {// console.log('this.auth', this.auth.data.id);
  },
  methods: {
    edit: function edit(row) {
      ...
      this.passwordOptions = [{
        text: trans('formLabels.passwordDontChange'),
        value: 'dontChange'
      }, {
        text: trans('formLabels.passwordChange'),
        value: 'change'
      }, {
        text: trans('formLabels.passwordAuto'),
        value: 'auto'
      ...
      try {
        for (var _iterator2 = row.item.stores[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
          var _store = _step2.value;
          this.form.stores.push(_store.id);
        }
      } catch (err) {
        _didIteratorError2 = true;
        _iteratorError2 = err;
    ...
    update: function update() {
      ...
      this.form.put(['users.update', {
        user: this.userRow.item.id
      }]).then(function (updatedUser) {
        Event.emit('scUpdateDisplayRow', {
          index: _this2.userRow.index,
          data: updatedUser
        });
    ...
    deleteUser: function deleteUser() {
      ...
      this.form["delete"](['users.destroy', {
        user: this.userRow.item.id
      }]).then(function (data) {
    ...
    isOwner: function isOwner(row) {
      var user = new _core_User__WEBPACK_IMPORTED_MODULE_1__["default"](row);
  ...
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_0__["mapGetters"])({
    ...
    userFormTitle: function userFormTitle() {
      return this.userRow ? trans('user.editFormTitle', {
        user: this.userRow.item.displayName
      }) : trans('user.newAccountTitle');
    },
    deleteUserMsg: function deleteUserMsg() {
      return this.userRow ? trans('user.deleteUser', {
        user: this.userRow.item.displayName
      }) : '';
    }
  })
...
module.exports = __webpack_require__(/*! C:\Users\Andy\Google_Drive\wamp\www\storecreator\resources\js\users\index.js */"./resources/js/users/index.js");
